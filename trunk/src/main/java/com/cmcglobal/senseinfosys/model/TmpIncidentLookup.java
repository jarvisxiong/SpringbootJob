 ...
 * 
 * @author NVAn
 * File name：TmpIncidentLookup.java
 * 
 * <MODIFICATION HISTORY>
 *   (Rev.)     (Date)       (ID/NAME)                      (Comment)
 *   Rev 1.00   2015/07/27    TmpIncidentLookupModel        Create New
 */
@Entity
@Table(name = "\"TMP_INCIDENT_LOOKUP\"")
@IdClass(IncidentLookupID.class)
public class TmpIncidentLookup implements Serializable {
	/**
	 * 
	 */
	...
	public boolean equals(Object obj) {
		if (obj == this)
			return true;
		if (!(obj instanceof TmpIncidentLookup)) {
			return false;
		}

		TmpIncidentLookup incidentLookup = (TmpIncidentLookup) obj;
