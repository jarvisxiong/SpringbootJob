...
public class OcbcEvoucherTest {
  ...
  private OcbcEvoucher ocbcEvoucher;
  ...
  private void basicSetup() throws Exception {
    ...
    evoucherQtyMap.put("OCBC_E_VOUCHER", 1L);
    EVoucherView viewMultiUsage =
        new EVoucherView("MCjT1X5GTU", "OCBC_E_VOUCHER", 10L, "1", formatter.parse(startDate),
    ...
    ocbcEvoucher =
        new OcbcEvoucher(messageSource, paymentMethod, ccRegex, creditCardNo, productPaymentMethod,
            userPaymentMethod, evoucherQtyMap, Arrays.asList(viewMultiUsage));
    ocbcEvoucher.setEvoucher(eVoucherViewList);
  ...
  public void validateAtApplyEvoucher() throws Exception {
    basicSetup();
    EVoucherValidation result = ocbcEvoucher.validateAtApplyEvoucher();
    assertTrue(ocbcEvoucher.getMaxQuantityRule().isExecuted());
    assertTrue(ocbcEvoucher.getMultiUsageRule().isExecuted());
    assertTrue(ocbcEvoucher.getRedeemRestrictionsRule().isExecuted());
    EVoucherValidation expected =
        objectMapper
            .readValue(
                this.getClass().getResource(
                    "/evoucher/json/evoucherValidation_OcbcEvoucher_Pass.json"),
  ...
  public void validateAtPreCommitOrder() throws Exception {
    basicSetup();
    EVoucherValidation result = ocbcEvoucher.validateAtPreCommitOrder();
    assertTrue(ocbcEvoucher.getCreditCardRule().isExecuted());
    assertTrue(ocbcEvoucher.getAllowedPaymentMethodRule().isExecuted());
    EVoucherValidation expected =
        objectMapper
            .readValue(
                this.getClass().getResource(
  ...
  public void setEvoucherCaseCreditCard() throws Exception {
    ...
    ocbcEvoucher =
        new OcbcEvoucher(messageSource, paymentMethod, ccRegex, creditCardNo, productPaymentMethod,
            userPaymentMethod, evoucherQtyMap, null);
    ocbcEvoucher.setEvoucher(eVoucherViewList);
    EVoucherView result = ocbcEvoucher.getCreditCardRule().getEVoucherView();
  ...
  public void setEvoucherCaseRedeemRestriction() throws Exception {
    ...
    ocbcEvoucher =
        new OcbcEvoucher(messageSource, paymentMethod, ccRegex, creditCardNo, productPaymentMethod,
            userPaymentMethod, evoucherQtyMap, null);
    ocbcEvoucher.setEvoucher(eVoucherViewList);
    EVoucherView result = ocbcEvoucher.getRedeemRestrictionsRule().getEVoucherView();
  ...
  public void setEvoucherCaseMaxQuantity() throws Exception {
    ...
    ocbcEvoucher =
        new OcbcEvoucher(messageSource, paymentMethod, ccRegex, creditCardNo, productPaymentMethod,
            userPaymentMethod, evoucherQtyMap, null);
    ocbcEvoucher.setEvoucher(eVoucherViewList);
    EVoucherView result = ocbcEvoucher.getMaxQuantityRule().getEVoucherView();
  ...
  public void setEvoucherCaseMultiUsage() throws Exception {
    ...
    ocbcEvoucher =
        new OcbcEvoucher(messageSource, paymentMethod, ccRegex, creditCardNo, productPaymentMethod,
            userPaymentMethod, evoucherQtyMap, null);
    ocbcEvoucher.setEvoucher(eVoucherViewList);
    EVoucherView result = ocbcEvoucher.getMultiUsageRule().getEVoucherView();
  ...
  public void setEvoucherCaseAllowedPaymentMethod() throws Exception {
    ...
    ocbcEvoucher =
        new OcbcEvoucher(messageSource, paymentMethod, ccRegex, creditCardNo, productPaymentMethod,
            userPaymentMethod, evoucherQtyMap, null);
    ocbcEvoucher.setEvoucher(eVoucherViewList);
    EVoucherView result = ocbcEvoucher.getAllowedPaymentMethodRule().getEVoucherView();
