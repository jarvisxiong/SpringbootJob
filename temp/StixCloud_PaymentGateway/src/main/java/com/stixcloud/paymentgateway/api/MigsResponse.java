...
public class MigsResponse implements Serializable {
  ...
  public MigsResponse(Builder builder) {
  ...
  public boolean equals(Object o) {
    ...
    MigsResponse that = (MigsResponse) o;
    ...
    return Objects.equals(this.vpcOrderInfo, that.vpcOrderInfo) &&
        ...
        Objects.equals(this.resData, that.resData) &&
  ...
  public int hashCode() {
    return Objects.hash(vpcOrderInfo, vpcTxnResponseCode, vpcAcqResponseCode, vpcTransactionNo,
        ...
        vpcAuthorizeId, vpcBatchNo, vpcCSCResultCode, vpcAcqCSCRespCode, reqData, resData);
  }
  ...
  public static final class Builder {
    ...
    public Builder(String response, String request) {
      ...
      while (keyValuePairToken.hasMoreTokens()) {
        ...
        while (keyValueDataToken.hasMoreTokens()) {
          ...
          if (keyValueDataToken.hasMoreTokens()) {
            ...
            } else if (StringUtils.isNotBlank(key) && "vpc_AuthorizeId".equals(key)) {
              this.vpcAuthorizeId = value;
            }
          }
        } // end while
      } // while loop
    ...
    public Builder resData() {
      return this;
    }

    public MigsResponse build() {
      return new MigsResponse(this);
    }
