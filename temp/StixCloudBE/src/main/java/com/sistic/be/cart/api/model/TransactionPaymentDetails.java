...
public class TransactionPaymentDetails {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(subAmount, that.subAmount) && Objects.equals(paymentMethodCode, that.paymentMethodCode);
	}
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.JSON_STYLE).append("subAmount", subAmount)
				.append("paymentMethodCode", paymentMethodCode).toString();
	}
}